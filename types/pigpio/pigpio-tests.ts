...
(function wave_chain(): void {
    ...
    const firstWaveForm: pigpio.pulses[] = [];
    const secondWaveForm: pigpio.pulses[] = [];
    const result: number[][] = [];
    ...
    const firstWaveId = pigpio.waveCreate();
    ...
    const secondWaveId = pigpio.waveCreate();
...
(function waves(): void {
    ...
    const waveLength = pigpio.waveAddGeneric(waveform);
    ...
    const thirdWaveId = pigpio.waveCreate();
